...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Dev Name Service", "DNS") {
        tld = _tld;
        owner = payable(0x2c9584a1F091805284A7E27403cEfd18ea6F1A90);
    }
  ...
  string svgPartTwo = '</text></svg>';
    ...
    function register(string memory _name) public payable {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name":"', name, '", "description":"A Domain On The Dev Name Service", "image":"data:image/svg+xml;base64,', Base64.encode(bytes(finalSvg)), '", "length":"',strLen,'"}'))));
    ...
    function getRecord(string memory _name)
        public
        view
